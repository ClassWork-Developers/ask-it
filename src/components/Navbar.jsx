...
export default function Nav() {
	...
	function scroll() {
		...
		setinicioViewPort(
			inicioId.top < (window.innerHeight || document.documentElement.clientHeight) &&
				inicioId.bottom > 0
		);
		setnosotrosViewPort(
			nosotrosId.top < (window.innerHeight || document.documentElement.clientHeight) &&
				nosotrosId.bottom > 0
		);
		setusoViewPort(
			usoId.top < (window.innerHeight || document.documentElement.clientHeight) &&
				usoId.bottom > 0
		);
		console.log();
	}
