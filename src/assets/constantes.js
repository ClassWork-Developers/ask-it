...
const navigationSesion = [
  ...
  {name:'Mis formularios', href:'/sesion/Mis-Formularios', current:false, icon:'M4 4v2.586a1 1 0 00.293.707l6 6a1 1 0 001.414 0l1.586-1.586a1 1 0 000-1.414l-6-6a1 1 0 00-.707-.293H4zm10.707 3.707a1 1 0 010 1.414L11.414 12l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z'}
];
const steps = [
  {
    id: 1,
